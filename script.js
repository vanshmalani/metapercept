...
const data = [{
    ...
    "ImageUrl": "https://www.google.com/search?sca_esv=c6ea4b9e8e44c565&sxsrf=ACQVn08t7lFULXdj79dbCCpt0cJ4ByaGig:1707119663835&q=image&tbm=isch&source=lnms&sa=X&ved=2ahUKEwjXnpup3JOEAxUr6TgGHXXSA40Q0pQJegQIDRAB#imgrc=dv6GfFyXggMvFM",
...
for (let i  = 0; i < data.length; i++){
    const{
        ID,ImageUrl,Name,ShortDesc 
    }=data[i]
    boxContainer.innerHTML=boxContainer.innerHTML+`<div class="box">
    <div class= "image"></div>
    <h4>${Name}</h4>
    <p>${ShortDesc}</p>
    <button>view</button>
